...
观察者眼点 $\mathbf{E}=(L,0,H_E)$。设主视线 $\hat{\mathbf{v}}_0=(-1,0,0)$ 指向圆柱轴心，虚拟视平面 $\Pi$ 垂直于主视线、距眼点 $d_0$，即
...
| 步骤 | 操作 | 关键公式 / 说明 |
|------|------|------------------|
| 1. 参数预设 | 读入 $I_{\mathrm{ref}}$；设定 $R,H,\mathbf{E}=(L,0,H_E),d_0$，以及圆柱在 A4 上的放置点 $(X_0,Y_0)$ | A4 竖置：$X\in[0,210]$ mm，$Y\in[0,297]$ mm |
